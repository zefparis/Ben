...
if __name__ == "__main__":
    ...
    # Définition robuste du chemin de la base avec création auto du dossier logs/
    DB_NAME = os.getenv(
        "DB_PATH",
        f'logs/runs-{datetime.now().strftime("%Y-%m-%d-%H-%M")}.db',
    )
    # Création du dossier parent si besoin (sécurise l'appel sqlite3)
    ...
    # Chargement du template de requête
    with open(
